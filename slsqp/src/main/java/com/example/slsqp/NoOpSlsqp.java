...
public class NoOpSlsqp implements SlsqpSolver
{
    ...
    public NoOpSlsqp(Vector2ScalarFunc objectiveFunc, double[] objectiveFuncJacobian, double[] x)
    {
        ...
        CallBackFunc callBackFunc)
    {
        ...
        NativeUtils.slsqp_no_op(m, meq, la, x, xl, xu, new double[] {fx}, c, g, a, acc, majiter, mode, w, jw,
