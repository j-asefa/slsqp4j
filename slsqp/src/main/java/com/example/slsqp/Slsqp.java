...
public class Slsqp
{
    ...
    public void minimize_slsqp_with_scalar_constraints(
    ...
    {
        final WrappedScalarFunction wrappedObjectiveFunction = new WrappedScalarFunction(objectiveFunc, arg);
        ...
        int la = scalarConstraintList.size();
